...
public class EditQuestionForm extends SideMenuBaseForm {
    ...
    public EditQuestionForm(Resources res,int id,String titre,String contenu) {
        super(BoxLayout.y());
        ...
        btnEdit.addActionListener(evt -> {
            ...
            if(testSaisie()){
                ...
                QuestionService.getInstance().editQuestion(id,tfTitre.getText(),tfContenu.getText(),"image.png",Integer.parseInt(idtag),Integer.parseInt(idcat),1);
                Dialog.show("Edit Question", "successfully updated", "ok", null);
