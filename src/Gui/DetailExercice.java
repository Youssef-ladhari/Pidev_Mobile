 ...
 * @author USER
 */
public class DetailExercice extends SideMenuBaseForm {
        SideMenuBaseForm current;
   public DetailExercice(Resources res, Form previous, Exercice p) {
        super(BoxLayout.y());
        current = this;
        ...
        returnButton.addActionListener(e -> new ExerciceFormm(res, current).showBack());
