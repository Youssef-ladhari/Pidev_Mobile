...
import static Gui.CoursForm.res;
 ...
 * @author AmiraDoghri
 */
public class ExerciceFormm extends SideMenuBaseForm {
    ...
    public ExerciceFormm(Resources res, Form previous) {
        super(BoxLayout.y());
        this.res = res;
        current = this;
   ...
   Button edit = new Button(FontImage.MATERIAL_EDIT, "icon");
        ...
        edit.addActionListener((evt) -> {
            ...
            new UpdateExercice(res, this, p).show();
        ...
        delete.addActionListener((evt) -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cet exercice ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
            ...
            //System.out.println("l'id cours est \n"+p.getId());
                if(ServiceExercice.getInstance().deleteCours(p.getId())) {
