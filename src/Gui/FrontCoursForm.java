 ...
 * @author USER
 */
public class FrontCoursForm extends SideMenuBaseForm {
    ...
    public FrontCoursForm(Resources res, Form previous) {
        super(BoxLayout.y());
        ...
        Container titleCmp = BoxLayout.encloseY(
                ...
                BorderLayout.centerAbsolute(
                        BoxLayout.encloseY(new Label("Les cours", "CenterTitle"))
                ),
...
Allprojects.setLeadComponent(all);
    ...
    private void addProjectBox(Cours p) {
        ...
        subject.add(icon1);
        subject.add(new Label(p.getTitre(),"TodayEntry"));
        Container teacher = new Container(BoxLayout.x());
        teacher.add(icon2);
        teacher.add(new Label(p.getTitre(),"TodayEntry"));
        ...
        view.addActionListener((evt) -> {
           // new DetailCoursFront(res, current, p).show();
